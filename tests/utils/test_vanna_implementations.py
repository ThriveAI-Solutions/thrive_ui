...
class TestMyVannaAnthropic:
    ...
    def test_init(self):
        with patch("utils.vanna_calls.VannaDB_VectorStore.__init__", return_value=None) as mock_vannadb_init, \
...
class TestMyVannaOllama:
    ...
    def test_log(self):
        with patch("utils.vanna_calls.VannaDB_VectorStore.__init__", return_value=None), \
