...
@pytest.fixture
def allergies_csv() -> pd.DataFrame:
    """Synthea allergies.csv shape. pat-001 has a penicillin drug allergy.
    pat-003 has a peanut food allergy. pat-002 has none."""
    data = """START,STOP,PATIENT,ENCOUNTER,CODE,SYSTEM,DESCRIPTION,TYPE,CATEGORY,REACTION1,DESCRIPTION1,SEVERITY1,REACTION2,DESCRIPTION2,SEVERITY2
2010-05-01,,pat-001,enc-001,91936005,SNOMED-CT,Allergy to penicillin,allergy,medication,247472004,Hives,MODERATE,,,
2018-03-01,,pat-003,enc-003,91934008,SNOMED-CT,Allergy to peanut,allergy,food,247472004,Hives,MILD,,,
"""
    return pd.read_csv(StringIO(data))
