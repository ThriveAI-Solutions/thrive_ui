...
def render_tool_call_message(message, index: int) -> None:
    ...
    with st.expander(label, expanded=False):
        ...
        # Executed SQL + raw row data — surfaced for all roles per the
        # "give everybody the highest permissions" directive (Phase 3
        # design §3.7). The card itself is collapsed by default so this
        # is opt-in for any user.
