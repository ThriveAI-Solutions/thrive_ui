...
def _build_admissions_result(
    ...
    return ClinicalResult(
        ...
        reliability_note=(
            ...
            "A visit is any real patient-facility contact: visits whose only ADT "
            "messages are administrative updates (A08/A31) are still reported, "
            "because some source systems (for example radiology groups) report "
            "outpatient encounters that way. Pre-admit/pending placeholders "
            "(A05/A14/A38/A27 or a 'P' setting) and cancelled admits are excluded. "
